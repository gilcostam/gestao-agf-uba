...
// Chaves de acesso dos cursos do Portal de Capacitação (Moodle), extraído da planilha oficial.
// 'aplicavel' lista os tipos de unidade que precisam do curso (AGF = nossa unidade).
const CURSOS_CHAVES = [
  { nome: 'Novo Acordo Ortográfico da Língua Portuguesa', ch: 4.0, codigo: 'TRC0001', modalidade: 'autoinstrucional', chave: '4MXTVEMQYL', aplicavel: ['AGF'] },
  { nome: 'Aprendendo Libras Como Segunda Língua - Nível Básico', ch: 16.0, codigo: 'TRC0003', modalidade: 'autoinstrucional', chave: 'M2L87WEV35', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Avante Brasil – Trilhas de Sucesso', ch: 1.0, codigo: 'TRC0005', modalidade: 'autoinstrucional', chave: '8FZ68MLYUV', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Balcão do Cidadão - Conhecendo o serviço', ch: 2.0, codigo: 'TRC0006', modalidade: 'autoinstrucional', chave: '65KENF84CT', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Balcão do Cidadão - Procedimentos de Atendimento', ch: 2.0, codigo: 'TRC0007', modalidade: 'autoinstrucional', chave: 'TL4ZJCEWTJ', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Balcão do Cidadão - Procedimentos Operacionais', ch: 2.0, codigo: 'TRC0008', modalidade: 'autoinstrucional', chave: 'NMV3Z58YP8', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Cnp Odonto', ch: 2.0, codigo: 'TRC0009', modalidade: 'autoinstrucional', chave: 'G848WWFTJM', aplicavel: ['AGF'] },
  { nome: 'Carnê do Baú Jequiti', ch: 6.0, codigo: 'TRC0012', modalidade: 'autoinstrucional', chave: '4ZD6XR7LRQ', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Carta e Carta Social', ch: 1.0, codigo: 'TRC0013', modalidade: 'autoinstrucional', chave: 'C6MDDMRYEG', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Celebração de Contratos Comerciais via SEI', ch: 4.0, codigo: 'TRC0014', modalidade: 'autoinstrucional', chave: 'WMY5JMT6TW', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Cibersegurança e LGPD', ch: 7.0, codigo: 'TRC0016', modalidade: 'autoinstrucional', chave: '83TDN9E5Q3', aplicavel: ['AGF', 'ACF', 'ACC', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Conhecendo os Correios - Rede Terceirizada', ch: 16.0, codigo: 'TRC0021', modalidade: 'autoinstrucional', chave: '5LTD7HZYW6', aplicavel: ['AGF', 'ACF', 'ACC', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Contratos Comerciais', ch: 6.0, codigo: 'TRC0022', modalidade: 'autoinstrucional', chave: 'LJF8PRNP3Q', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Correios Celular', ch: 2.0, codigo: 'TRC0023', modalidade: 'autoinstrucional', chave: '2F4UGVRX5C', aplicavel: ['AGF', 'ACF', 'ACC', 'CMD', 'LCF'] },
  { nome: 'Correios Celular - Vendas na Prática', ch: 6.0, codigo: 'TRC0024', modalidade: 'autoinstrucional', chave: 'RVKEFJD9R9', aplicavel: ['AGF', 'ACC', 'CMD'] },
  { nome: 'Documento Internacional', ch: 2.0, codigo: 'TRC0027', modalidade: 'autoinstrucional', chave: 'UN35R94J6N', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Embalagem e Acondicionamento', ch: 1.0, codigo: 'TRC0029', modalidade: 'autoinstrucional', chave: 'VQPR3T55F4', aplicavel: ['AGF', 'CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'ENSINA AÍ: Mini envios – Atendimento', ch: 3.0, codigo: 'TRC0031', modalidade: 'autoinstrucional', chave: 'Z7G9J5C5R9', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Ergonomia - Novo Mobiliário - Atendente Comercial', ch: 2.0, codigo: 'TRC0034', modalidade: 'autoinstrucional', chave: 'UXXJENZMQ8', aplicavel: ['AGF'] },
  { nome: 'Estudo e Aprendizado a Distância', ch: 8.0, codigo: 'TRC0035', modalidade: 'autoinstrucional', chave: 'JF9WURJLW6', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Ética é para todos', ch: 6.0, codigo: 'TRC0036', modalidade: 'autoinstrucional', chave: '9JUDG3R8JG', aplicavel: ['AGF', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Exporta Fácil', ch: 2.0, codigo: 'TRC0037', modalidade: 'autoinstrucional', chave: 'KZZGGXTWJV', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Impresso AGF', ch: 1.0, codigo: 'TRC0039', modalidade: 'autoinstrucional', chave: 'F27WMZTYCT', aplicavel: ['AGF', 'CMD'] },
  { nome: 'Limpa Nome SERASA', ch: 1.0, codigo: 'TRC0043', modalidade: 'autoinstrucional', chave: 'GTUTMY2MZH', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Mala Direta Domiciliaria', ch: 1.0, codigo: 'TRC0046', modalidade: 'autoinstrucional', chave: 'K64DHGQN5P', aplicavel: ['AGF', 'CMD'] },
  { nome: 'PAC', ch: 1.0, codigo: 'TRC0047', modalidade: 'autoinstrucional', chave: 'VNY3ZG56F3', aplicavel: ['AGF', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Pagamento na Entrega - Sedex e PAC', ch: 1.0, codigo: 'TRC0048', modalidade: 'autoinstrucional', chave: '3WUTH2DQ7W', aplicavel: ['AGF', 'CMD'] },
  { nome: 'PRONEG-Conhecendo o Sistema', ch: 1.0, codigo: 'TRC0061', modalidade: 'autoinstrucional', chave: 'G55CTVCPWN', aplicavel: ['AGF', 'ACF', 'LCF'] },
  { nome: 'PRONEG-Vendas', ch: 1.0, codigo: 'TRC0062', modalidade: 'autoinstrucional', chave: 'FQK95YPJQ9', aplicavel: ['AGF', 'ACF', 'LCF'] },
  { nome: 'Recebimento de Contas', ch: 1.0, codigo: 'TRC0065', modalidade: 'autoinstrucional', chave: 'N6HK37XFVZ', aplicavel: ['AGF', 'CMD'] },
  { nome: 'SAD - Sistema de Apoio à Decisão - Gestão de Clientes', ch: 4.0, codigo: 'TRC0066', modalidade: 'autoinstrucional', chave: 'NKY7LCYV8E', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'SARA - Administrador Local', ch: 2.0, codigo: 'TRC0068', modalidade: 'autoinstrucional', chave: '4WYXFTJ9K3', aplicavel: ['AGF', 'ACF'] },
  { nome: 'SARA – Caixa Retaguarda', ch: 8.0, codigo: 'TRC0070', modalidade: 'autoinstrucional', chave: 'X94HW7H8G7', aplicavel: ['AGF', 'ACF'] },
  { nome: 'SARA - Conhecendo o sistema', ch: 3.0, codigo: 'TRC0071', modalidade: 'autoinstrucional', chave: '8855Z46PVK', aplicavel: ['AGF', 'CMD'] },
  { nome: 'SARA - Expedidor', ch: 4.0, codigo: 'TRC0072', modalidade: 'autoinstrucional', chave: '5KG6EZ5K2C', aplicavel: ['AGF', 'ACF'] },
  { nome: 'SGM - Sistema de Gerenciamento de Mensagens', ch: 3.0, codigo: 'TRC0086', modalidade: 'autoinstrucional', chave: 'VFFH4QX4UP', aplicavel: ['AGF', 'CMD'] },
  { nome: 'SISCAP -  Sistema de Captação de Pedidos', ch: 4.0, codigo: 'TRC0087', modalidade: 'autoinstrucional', chave: 'YW3UKLLM76', aplicavel: ['AGF', 'ACF', 'ACC', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Telegrama Nacional', ch: 1.0, codigo: 'TRC0089', modalidade: 'autoinstrucional', chave: '897WX9KNJY', aplicavel: ['AGF', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Triagem e Expedição - Agência', ch: 1.0, codigo: 'TRC0090', modalidade: 'autoinstrucional', chave: 'N86GVQG58R', aplicavel: ['AGF', 'ACF', 'ACC', 'CMD', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Caixa Postal AGF', ch: 1.0, codigo: 'TRC0091', modalidade: 'autoinstrucional', chave: '4LVPL675TY', aplicavel: ['AGF'] },
  { nome: 'Caixas e Envelopes dos Correios', ch: 1.0, codigo: 'TRC0092', modalidade: 'autoinstrucional', chave: 'LNZKD8EHM7', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Cecograma', ch: 1.0, codigo: 'TRC0093', modalidade: 'autoinstrucional', chave: 'XV4FNWFQCN', aplicavel: ['AGF'] },
  { nome: 'Mala Direta Básica', ch: 1.0, codigo: 'TRC0095', modalidade: 'autoinstrucional', chave: 'XYN5ZV288M', aplicavel: ['AGF', 'LCF'] },
  { nome: 'SARA – Caixa Atendimento Encomenda', ch: 2.0, codigo: 'TRC0096', modalidade: 'autoinstrucional', chave: '4HKNQQ26FZ', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Atendimento Internacional', ch: 2.0, codigo: 'TRC0097', modalidade: 'autoinstrucional', chave: 'Y42QT27ZHK', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Atendimento Mensagem e Marketing', ch: 2.0, codigo: 'TRC0098', modalidade: 'autoinstrucional', chave: 'XEDXC46LMG', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Atendimento Serviços de Terceiros', ch: 1.0, codigo: 'TRC0099', modalidade: 'autoinstrucional', chave: 'UYZDZP2XM8', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Atendimento Varejo', ch: 2.0, codigo: 'TRC0100', modalidade: 'autoinstrucional', chave: '6MEXWGUYDP', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Funcionalidades', ch: 4.0, codigo: 'TRC0101', modalidade: 'autoinstrucional', chave: 'VDGWD98RH8', aplicavel: ['AGF'] },
  { nome: 'SARA – Caixa Introdução ao Atendimento', ch: 1.0, codigo: 'TRC0102', modalidade: 'autoinstrucional', chave: 'LT8CVRGDXJ', aplicavel: ['AGF'] },
  { nome: 'Selos Postais', ch: 1.0, codigo: 'TRC0103', modalidade: 'autoinstrucional', chave: '5U8M64X345', aplicavel: ['AGF'] },
  { nome: 'Serviços Complementares', ch: 2.0, codigo: 'TRC0104', modalidade: 'autoinstrucional', chave: 'GXKGM4CJ98', aplicavel: ['AGF', 'Essencial (CEL)'] },
  { nome: 'Vale Postal Digital', ch: 1.0, codigo: 'TRC0108', modalidade: 'autoinstrucional', chave: 'THCEXTENXV', aplicavel: ['AGF', 'ACC'] },
  { nome: 'Locker – Conhecendo o Canal', ch: 1.0, codigo: 'TRC0109', modalidade: 'autoinstrucional', chave: 'VC4HWV8QLH', aplicavel: ['AGF', 'ACF', 'Novo CMD', 'LCF'] },
  { nome: 'CEPED Cursos', ch: 1.0, codigo: 'TRC0110', modalidade: 'autoinstrucional', chave: 'GQP3PJN3WH', aplicavel: ['AGF'] },
  { nome: 'Locker – Atendimento', ch: 1.0, codigo: 'TRC0111', modalidade: 'autoinstrucional', chave: '73ZYCD6JYM', aplicavel: ['AGF', 'ACF'] },
  { nome: 'Facilitador de TLT', ch: 4.0, codigo: 'TRC0112', modalidade: 'autoinstrucional', chave: '5QVF8TY84C', aplicavel: ['AGF', 'ACF', 'ACC', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Balcão do Cidadão – CAP Vencedor PM', ch: 2.0, codigo: 'TRC0113', modalidade: 'autoinstrucional', chave: 'Q7MDLJWQPN', aplicavel: ['AGF'] },
  { nome: 'Conhecendo o Franqueamento por estampa 2D', ch: 1.0, codigo: 'TRC0115', modalidade: 'autoinstrucional', chave: 'Q6GMX22DWL', aplicavel: ['AGF'] },
  { nome: 'Franqueamento 2D  a Faturar – Agência', ch: 1.0, codigo: 'TRC0116', modalidade: 'autoinstrucional', chave: 'CNUJQYCGK6', aplicavel: ['AGF'] },
  { nome: 'Atendimento à pessoa com deficiência', ch: 2.0, codigo: 'TRC0117', modalidade: 'autoinstrucional', chave: 'CDN9HEWT8R', aplicavel: ['AGF', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Balcão do Cidadão – Curso Venda Online Brasil', ch: 1.0, codigo: 'TRC0119', modalidade: 'autoinstrucional', chave: 'ZH8TE8L6UM', aplicavel: ['AGF', 'ACC'] },
  { nome: 'Balcão do Cidadão – Protocolo Órgãos Judiciais', ch: 1.0, codigo: 'TRC0120', modalidade: 'autoinstrucional', chave: 'LF3LDK5KLQ', aplicavel: ['AGF', 'ACF'] },
  { nome: 'RDVO Digital', ch: 6.0, codigo: 'TRC0121', modalidade: 'autoinstrucional', chave: '3E2Q845XCL', aplicavel: ['AGF', 'Novo CMD', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Correios Atende – AGF', ch: 6.0, codigo: 'TRC0122', modalidade: 'autoinstrucional', chave: '7CLQHCPPK9', aplicavel: ['AGF'] },
  { nome: 'Compliance Concorrencial', ch: 11.0, codigo: 'TRC0123', modalidade: 'autoinstrucional', chave: 'WV45QFNL64', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Balcão do Cidadão – Epson Venda Refil de Tinta', ch: 1.0, codigo: 'TRC0124', modalidade: 'autoinstrucional', chave: 'R7V5KYZZ76', aplicavel: ['AGF'] },
  { nome: 'Mala Direta Endereçada (postagem industrial)', ch: 4.0, codigo: 'TRC0125', modalidade: 'autoinstrucional', chave: 'K2FH9HWZDG', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Balcão do Cidadão – DNIT', ch: 4.0, codigo: 'TRC0126', modalidade: 'autoinstrucional', chave: 'PHH8VQW9C4', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Destrave suas Vendas', ch: 8.0, codigo: 'TRC0129', modalidade: 'autoinstrucional', chave: 'R52X4J3HTW', aplicavel: ['AGF', 'LCF'] },
  { nome: 'Chave para Resultados em Vendas ', ch: 10.0, codigo: 'TRC0130', modalidade: 'autoinstrucional', chave: 'JRGK5P2QFU', aplicavel: ['AGF', 'Novo CMD', 'LCF'] },
  { nome: 'Balcão do Cidadão – CAP Vencedor PU', ch: 2.0, codigo: 'TRC0132', modalidade: 'autoinstrucional', chave: 'EC5FL2GGJV', aplicavel: ['AGF', 'ACF', 'ACC'] },
  { nome: 'Balcão do cidadão – Doutor Orienta (GO) ', ch: 2.0, codigo: 'TRC0133', modalidade: 'autoinstrucional', chave: 'EF9DDXDWJE', aplicavel: ['AGF'] },
  { nome: 'Franqueamento 2D a Vista - Agência', ch: 1.0, codigo: 'TRC0134', modalidade: 'autoinstrucional', chave: 'UC88T6939F', aplicavel: ['AGF', 'ACC'] },
  { nome: 'SRO Web – Entrega Interna', ch: 4.0, codigo: 'TRC0135', modalidade: 'autoinstrucional', chave: 'EXQXYL483X', aplicavel: ['AGF', 'LCF', 'Essencial (CEL)'] },
  { nome: 'Balcão do Cidadão – Seguros', ch: 6.0, codigo: 'TRC0141', modalidade: 'autoinstrucional', chave: 'E2ZFU3ZLUF', aplicavel: [] },
  { nome: 'Hipercap Litoral – SP', ch: 2.0, codigo: 'TRC0142', modalidade: 'autoinstrucional', chave: 'VZ37NUU8YG', aplicavel: [] },
  { nome: 'Prevenção e Enfrentamento aos Assédios e à Discriminação', ch: 16.0, codigo: 'TRC0144', modalidade: 'autoinstrucional', chave: 'RPJQ72HC66', aplicavel: ['AGF'] },
  { nome: 'Entrega Interna – Regras Gerais', ch: 2.0, codigo: 'TRC0145', modalidade: 'autoinstrucional', chave: 'X875PZQVMG', aplicavel: ['AGF', 'CMD'] },
  { nome: 'Minhas exportações (MEXPO)', ch: 4.0, codigo: 'TRC0146', modalidade: 'autoinstrucional', chave: 'JLNT6HQT45', aplicavel: ['AGF'] },
];
